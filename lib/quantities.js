  ...
  */
  ...
  window.Qty.prototype = {
    ...
    */
    ...
    toString: function(target_units_or_max_decimals, max_decimals) {
      var target_units;
      if(typeof target_units_or_max_decimals === "number") {
        max_decimals = target_units_or_max_decimals;
      }
      else if(typeof target_units_or_max_decimals === "string") {
        target_units = target_units_or_max_decimals;
      }
