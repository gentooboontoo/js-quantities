  ...
  */
  ...
  constructor.prototype = {
    ...
    */
    ...
    // max_decimals is used only when explicit target units are passed
    toString: function(target_units, max_decimals) {
      if(target_units.constructor == Number) {
        throw "Target units must be explicitly defined to round output.";
      }
      ...
      var out_scalar = max_decimals ? round(out.scalar, max_decimals) : out.scalar;
    ...
    mul: function(other) {
      ...
      else if(other.constructor == String) {
        other = new Qty(other);
      }
